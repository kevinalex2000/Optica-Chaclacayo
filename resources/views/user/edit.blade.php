...
<!-- Content -->
<div class="container-fluid">
    <form action="{{route('users.update', $user->id)}}" class="form-neon" autocomplete="off">
        <fieldset>
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[0-9-]{1,20}" class="form-control" name="usuario_dni_up" id="usuario_dni" value="{{$user->dni}}" maxlength="20">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" name="usuario_nombre_up" value="{{$user->name}}" id="usuario_nombre" maxlength="35">
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="usuario_apellido" class="bmd-label-floating">Apellidos</label>
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" name="usuario_apellido_up" value="{{$user->lastname}}" id="usuario_apellido" maxlength="35">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="usuario_telefono" class="bmd-label-floating">Teléfono</label>
                            <input type="text" pattern="[0-9()+]{8,20}" class="form-control" name="usuario_telefono_up" id="usuario_telefono" value="{{$user->phone}}" maxlength="20">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="usuario_direccion" class="bmd-label-floating">Dirección</label>
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="usuario_direccion_up" value="{{$user->direction}}" id="usuario_direccion" maxlength="190">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="usuario_email_up" id="usuario_email" value="{{$user->email}}" maxlength="70">
                        </div>
                    </div>
                    <!--<div class="col-12">
                        <div class="form-group">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p><span class="badge badge-success">Asistente de Ventas</span> Permisos para registrar y actualizar</p>
                        <div class="form-group">
